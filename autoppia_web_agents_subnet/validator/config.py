...
SEASON_SIZE_EPOCHS = _env_float("SEASON_SIZE_EPOCHS", 2.5, test_default=1.6666667)
# 1 hour with 360 blocks/epoch and ~12s/block => 300 blocks => 0.8333 epochs
ROUND_SIZE_EPOCHS = _env_float("ROUND_SIZE_EPOCHS", 0.8333, test_default=0.2778)
...
MINIMUM_START_BLOCK = _env_int("MINIMUM_START_BLOCK", 7703820)
